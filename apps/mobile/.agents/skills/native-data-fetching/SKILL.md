...
description: Use when implementing or debugging remote synchronization, Convex integration, caching, reconnection, or offline/online data flows in the native app. Do not trigger for local SQLite/domain work or ordinary UI state.
version: 1.0.0
license: MIT
...
- Implementing or debugging Convex synchronization
- Reconnection, retry, and remote-cache behavior
- Handling offline/online transitions at the integration boundary
- Authentication or tokens for a remote integration
- Configuring remote URLs and environment variables
