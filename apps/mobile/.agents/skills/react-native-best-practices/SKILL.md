...
description: Rendimiento de React Native/Expo. Usar cuando exista un problema medible de FPS, TTI, tamaño del bundle, memoria, re-renderizados, bloqueo del hilo JS, bridge, FlashList, módulos nativos, Hermes o caída de frames y jank en animaciones.
license: MIT
metadata:
  author: Callstack
