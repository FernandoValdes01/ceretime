 ...
 * o la revocación de una asignación de Practicante solo la realiza un
 * Profesional autorizado sobre el mismo acompañamiento, aunque el objetivo
 * haya perdido habilitación o vigencia; el acompañamiento inexistente o no
