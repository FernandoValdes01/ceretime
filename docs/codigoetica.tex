...
\begin{itemize}
    \item los integrantes de Taller de Integración II deberán informar a su Scrum Master;
    \item los integrantes de Taller de Integración IV deberán informar a su Scrum Master.
\end{itemize}
...
\begin{itemize}
    \item eliminar arbitrariamente ramas compartidas;
    \item eliminar trabajo perteneciente a otros integrantes;
    \item modificar deliberadamente el historial para ocultar acciones realizadas;
    \item eliminar commits relevantes sin coordinación previa.
\end{itemize}
